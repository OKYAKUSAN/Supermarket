<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SortDelete.aspx.cs" Inherits="Supermarket.Basic.SortDelete" %>
...
<body>
    <div class="p30">
        <div class="sendMsg">
            ...
            <div class="sendMsg-notice">如果<span>5</span>秒之后没有自动跳转，请点击<a href="/Basic/sortlist.aspx" target="rightFrame">这里</a>。</div>
        </div>
    </div>
    <script type="text/javascript">
        $(function () {
            ...
            var changeSecond = function () {
                ...
                if (second == 0)
                    window.location = "/Basic/sortlist.aspx";
                else second--;
            }
